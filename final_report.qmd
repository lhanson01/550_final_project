---
title: "DATA 550 Final Project: A simple seed-based analysis of functional connectivity in a single subject"
author: "Liam Hanson"
format: html
editor: visual
fig_caption: true
...
This code contains data download, necessary data processing as well as analysis including the creation of the brain mask, the selection of the seed voxel, the calculation of correlations across voxels and the sorting of voxels for visualization.
...
```{r}
#| echo: false
knitr::include_graphics(here::here("output/sag_con_plot.png"))
```

```{r}
#| echo: false
knitr::include_graphics(here::here("output/cor_con_plot.png"))
```

```{r}
#| echo: false
knitr::include_graphics(here::here("output/ax_con_plot.png"))
```
...
```{r}
#| echo: false
knitr::include_graphics(here::here("output/BOLD_lineplot.png"))
```
...
```{r, call-table}
#| echo: false
voxel_table <- readRDS("output/voxel_table.rds")
voxel_table
```

Total amount, mean, and standard deviation of voxels with negative or positive correlation to the seed voxel. More positive correlations were recorded than negative, though the correlation magnitudes and standard deviation were similar.
:::
...
Figure 2 shows similar BOLD intensities across the most-correlated voxels. Nearly all voxels displayed on this plot neighbored the seed voxel.
