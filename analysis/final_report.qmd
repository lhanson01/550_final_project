---
title: "DATA 550 Final Project 2: A simple seed-based analysis of functional connectivity in a single subject"
author: "Liam Hanson"
format: html
editor: visual
fig_caption: true
...
```{r}
#| echo: false
source(here("source", "00_download_data_550fp.R"))
```
...
```{r}
#| echo: false
source(here("source", "03_analyze_data_550fp.R"))
```
...
source(here("source", "04_visualize_data_550fp.R"))
```
...
```{r, call-table}
#| echo: false
source(here("source", "05_make_table.R"))
voxel_table
```
